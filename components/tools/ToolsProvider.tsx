...
export function ToolsResumeRibbon() {
  ...
  return (
    <button type="button" onClick={() => router.push("/tools?resume=1")} className="fixed inset-x-4 bottom-32 z-30 mx-auto flex max-w-[45rem] items-center justify-between rounded-card border border-line bg-raised px-4 py-3 text-left shadow-[var(--elev-card)] md:bottom-6 md:left-20 md:right-auto md:w-[min(45rem,calc(100vw-var(--space-6)))]">
